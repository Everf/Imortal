...
class boss_ascendant_pit_lord_obsidius : public CreatureScript
{
    public:
        boss_ascendant_pit_lord_obsidius() : CreatureScript("boss_ascendant_pit_lord_obsidius") { }

        struct boss_ascendant_pit_lord_obsidiusAI : public BossAI
        {
            boss_ascendant_pit_lord_obsidiusAI(Creature* creature) : BossAI(creature, DATA_ARGALOTH) { }
        ...
        {
            return GetBaradinHoldAI<boss_ascendant_pit_lord_obsidiusAI>(creature);
        }
};
...
void AddSC_boss_ascendant_pit_lord_obsidius()
{
    new boss_ascendant_pit_lord_obsidius();
